...
__static_renaming("__rmm_addr_216", "rmm_addr");
__static_renaming("__rmm_addr_217", "rmm_addr");
__static_renaming("__util_ald_create_cache_219", "util_ald_create_cache");
__static_renaming("__util_ald_create_caches_225", "util_ald_create_caches");
...
__static_condition_renaming("__static_condition_default_227", "!(defined _FORTIFY_SOURCE) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0)");
...
/* no function due to type errors in the function prototype */
/* no function due to type errors in the function prototype */
char  * (__rmm_addr_216);// L3
char  * (__rmm_addr_217);// L3
void  (__util_ald_create_cache_219) (char  * (__rmm_addr_218)) {
...
if (__static_condition_default_222) {
 __strcat_36  ( __rmm_addr_218 ,"something") ; // L8
}
...
if (__static_condition_default_227) {
 __util_ald_create_caches_225  ( __rmm_addr_216 ) ; // L21
}
if (__static_condition_default_228) {
 __util_ald_create_caches_225  ( __rmm_addr_217 ) ; // L21
}
return 0 ;// L22
}
}// L23
