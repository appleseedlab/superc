...
__static_renaming("__thisopt_252", "thisopt");
__static_renaming("__ssl_cmd_protocol_parse_253", "ssl_cmd_protocol_parse");
__static_renaming("__ssl_cmd_protocol_parse_254", "ssl_cmd_protocol_parse");
__static_renaming("__main_261", "main");
...
__static_condition_renaming("__static_condition_default_255", "!(defined _FORTIFY_SOURCE) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0)");
__static_condition_renaming("__static_condition_default_256", "!(defined _FORTIFY_SOURCE) && !(defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __USE_EXTERN_INLINES)");
__static_condition_renaming("__static_condition_default_257", "!(defined _FORTIFY_SOURCE) && (defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined __USE_EXTERN_INLINES) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined __USE_EXTERN_INLINES)");
__static_condition_renaming("__static_condition_default_258", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0)");
...
__static_condition_renaming("__static_condition_default_260", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined __USE_EXTERN_INLINES)");
...
/* no function due to type errors in the function prototype */
void  (__ssl_cmd_protocol_parse_253) () {
...
void  (__ssl_cmd_protocol_parse_254) () {
...
if (__static_condition_default_255) {
 __ssl_cmd_protocol_parse_253 ( ) ; // L19
}
if (__static_condition_default_258) {
 __ssl_cmd_protocol_parse_254 ( ) ; // L19
}
return 0 ;// L20
}
}
