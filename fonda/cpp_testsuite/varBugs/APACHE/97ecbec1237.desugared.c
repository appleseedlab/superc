...
__static_renaming("__cache_798", "cache");
__static_renaming("__cache_799", "cache");
__static_renaming("__util_ldap_shm_801", "util_ldap_shm");
__static_renaming("__apr_shm_attach_803", "apr_shm_attach");
__static_renaming("__apr_shm_create_808", "apr_shm_create");
__static_renaming("__result_817", "result");
__static_renaming("__util_ldap_cache_init_818", "util_ldap_cache_init");
__static_renaming("__main_821", "main");
...
__static_condition_renaming("__static_condition_default_800", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
...
__static_condition_renaming("__static_condition_default_805", "!(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_806", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_809", "!(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_810", "!(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_811", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_812", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined)");
__static_condition_renaming("__static_condition_default_813", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined)");
__static_condition_renaming("__static_condition_default_814", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) && (defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_815", "!(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_816", "!(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_819", "APR_HAS_SHARED_MEMORY");
__static_condition_renaming("__static_condition_default_820", "!APR_HAS_SHARED_MEMORY");
__static_condition_renaming("__static_condition_default_822", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_823", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined)");
__static_condition_renaming("__static_condition_default_824", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined)");
__static_condition_renaming("__static_condition_default_825", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) && (defined __malloc_and_calloc_defined)");
__static_condition_renaming("__static_condition_default_826", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_827", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
...
/* no function due to type errors in the function prototype */
int  * (__cache_798)= ( ( void  * ) 0 );// L6
int  * (__cache_799)= ( ( void  * ) 0 );// L6
int  * (__util_ldap_shm_801);// L7
int  (__apr_shm_attach_803) (int  * (* (__util_ldap_shm_802))) {
...
*  __util_ldap_shm_802  =  __cache_798  ; // L12
return 0 ;// L13
}
}
}
...
*  __util_ldap_shm_802  =  __cache_799  ; // L12
return 0 ;// L13
}
}
}
...
int  (__apr_shm_create_808) (int  * (* (__util_ldap_shm_807))) {
...
if (__static_condition_default_812) {
 __cache_798  =  __malloc_486  (sizeof(int)) ; // L22
}
if (__static_condition_default_813) {
 __cache_799  =  __malloc_487  (sizeof(int)) ; // L22
}
if (__static_condition_default_814) {
__static_type_error("type error") ; // L22
}
if (__static_condition_default_815) {
*  __util_ldap_shm_807  =  __cache_798  ; // L23
}
if (__static_condition_default_816) {
*  __util_ldap_shm_807  =  __cache_799  ; // L23
}
if (__static_condition_default_800) {
...
int  (__util_ldap_cache_init_818) () {
...
int  __result_817=  __apr_shm_create_808  (&  __util_ldap_shm_801 );// L30

if (__static_condition_default_819) {
if (  __result_817  != 1 )// L31
{
...
if (__static_condition_default_823) {
 __cache_798  =  __malloc_486  (sizeof(int)) ; // L41
}
if (__static_condition_default_824) {
 __cache_799  =  __malloc_487  (sizeof(int)) ; // L41
}
...
__static_type_error("invalid type found in if statement");
 ...
 __util_ldap_cache_init_818 ( ) ; // L43
return 0 ;// L44
}
}
