...
__static_renaming("__newuri_1084", "newuri");
__static_renaming("__apply_rewrite_rule_1085", "apply_rewrite_rule");
__static_renaming("__apply_rewrite_rule_1086", "apply_rewrite_rule");
__static_renaming("__main_1093", "main");
...
__static_condition_renaming("__static_condition_default_1087", "!(defined _FORTIFY_SOURCE) && !(defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1088", "!(defined _FORTIFY_SOURCE) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1089", "!(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && (defined HAS_APACHE_REGEX_LIB) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined HAS_APACHE_REGEX_LIB) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined HAS_APACHE_REGEX_LIB) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1090", "(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1091", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1092", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1094", "!(defined _FORTIFY_SOURCE) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0)");
__static_condition_renaming("__static_condition_default_1095", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0)");
__static_condition_renaming("__static_condition_default_1096", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) && (defined __CORRECT_ISO_CPP_STRING_H_PROTO) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __CORRECT_ISO_CPP_STRING_H_PROTO) || (defined _STDLIB_H) && (defined __CORRECT_ISO_CPP_STRING_H_PROTO)");
...
/* no function due to type errors in the function prototype */
/* no function due to type errors in the function prototype */
void  (__apply_rewrite_rule_1085) () {
...
if (__static_condition_default_1089) {
 __strncpy_847  ( __newuri_1084 ,"pregsub()",sizeof((  __newuri_1084  )) - 1) ; // L11
}
if (__static_condition_default_1090) {
 __strncpy_848  ( __newuri_1084 ,"pregsub()",sizeof((  __newuri_1084  )) - 1) ; // L11
}
 __newuri_1084  [ sizeof((  __newuri_1084  - 1 )) ] = '\0' ; // L12
}
}// L16
...
void  (__apply_rewrite_rule_1086) () {
...
if (__static_condition_default_1094) {
 __apply_rewrite_rule_1085 ( ) ; // L20
}
if (__static_condition_default_1095) {
 __apply_rewrite_rule_1086 ( ) ; // L20
}
return 0 ;// L21
}
}// L22
