...
__static_renaming("__newuri_1085", "newuri");
__static_renaming("__apply_rewrite_rule_1086", "apply_rewrite_rule");
__static_renaming("__apply_rewrite_rule_1087", "apply_rewrite_rule");
__static_renaming("__main_1094", "main");
...
__static_condition_renaming("__static_condition_default_1089", "!(defined _FORTIFY_SOURCE) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined HAS_APACHE_REGEX_LIB) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
...
__static_condition_renaming("__static_condition_default_1091", "(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined HAS_APACHE_REGEX_LIB) || (defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
...
__static_condition_renaming("__static_condition_default_1093", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined HAS_APACHE_REGEX_LIB)");
__static_condition_renaming("__static_condition_default_1095", "!(defined _FORTIFY_SOURCE) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0)");
...
__static_condition_renaming("__static_condition_default_1097", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
...
if (__static_condition_default_1090) {
 __strncpy_847  ( __newuri_1085 ,"pregsub()",sizeof((  __newuri_1085  )) - 1) ; // L11
}
if (__static_condition_default_1091) {
 __strncpy_848  ( __newuri_1085 ,"pregsub()",sizeof((  __newuri_1085  )) - 1) ; // L11
}
 __newuri_1085  [ sizeof((  __newuri_1085  - 1 )) ] = '\0' ; // L12
}
}
...
void  (__apply_rewrite_rule_1087) () {
