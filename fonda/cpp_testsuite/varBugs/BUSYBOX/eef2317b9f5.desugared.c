...
__static_renaming("____u_char_798", "__u_char");
__static_renaming("____u_short_799", "__u_short");
__static_renaming("____u_int_800", "__u_int");
__static_renaming("____u_long_801", "__u_long");
__static_renaming("____int8_t_802", "__int8_t");
__static_renaming("____uint8_t_803", "__uint8_t");
__static_renaming("____int16_t_804", "__int16_t");
__static_renaming("____uint16_t_805", "__uint16_t");
__static_renaming("____int32_t_806", "__int32_t");
__static_renaming("____uint32_t_807", "__uint32_t");
__static_renaming("____int64_t_808", "__int64_t");
__static_renaming("____uint64_t_809", "__uint64_t");
__static_renaming("____quad_t_810", "__quad_t");
__static_renaming("____u_quad_t_811", "__u_quad_t");
__static_renaming("____dev_t_812", "__dev_t");
__static_renaming("____uid_t_813", "__uid_t");
__static_renaming("____gid_t_814", "__gid_t");
__static_renaming("____ino_t_815", "__ino_t");
__static_renaming("____ino64_t_816", "__ino64_t");
__static_renaming("____mode_t_817", "__mode_t");
__static_renaming("____nlink_t_818", "__nlink_t");
__static_renaming("____off_t_819", "__off_t");
__static_renaming("____off64_t_820", "__off64_t");
__static_renaming("____pid_t_821", "__pid_t");
__static_renaming("____fsid_t_825", "__fsid_t");
__static_renaming("____clock_t_826", "__clock_t");
__static_renaming("____rlim_t_827", "__rlim_t");
__static_renaming("____rlim64_t_828", "__rlim64_t");
__static_renaming("____id_t_829", "__id_t");
__static_renaming("____time_t_830", "__time_t");
__static_renaming("____useconds_t_831", "__useconds_t");
__static_renaming("____suseconds_t_832", "__suseconds_t");
__static_renaming("____daddr_t_833", "__daddr_t");
__static_renaming("____key_t_834", "__key_t");
__static_renaming("____clockid_t_835", "__clockid_t");
__static_renaming("____timer_t_836", "__timer_t");
__static_renaming("____blksize_t_837", "__blksize_t");
__static_renaming("____blkcnt_t_838", "__blkcnt_t");
__static_renaming("____blkcnt64_t_839", "__blkcnt64_t");
__static_renaming("____fsblkcnt_t_840", "__fsblkcnt_t");
__static_renaming("____fsblkcnt64_t_841", "__fsblkcnt64_t");
__static_renaming("____fsfilcnt_t_842", "__fsfilcnt_t");
__static_renaming("____fsfilcnt64_t_843", "__fsfilcnt64_t");
__static_renaming("____fsword_t_844", "__fsword_t");
__static_renaming("____ssize_t_845", "__ssize_t");
__static_renaming("____syscall_slong_t_846", "__syscall_slong_t");
__static_renaming("____syscall_ulong_t_847", "__syscall_ulong_t");
__static_renaming("____loff_t_848", "__loff_t");
__static_renaming("____qaddr_t_850", "__qaddr_t");
__static_renaming("____caddr_t_851", "__caddr_t");
__static_renaming("____intptr_t_852", "__intptr_t");
__static_renaming("____socklen_t_853", "__socklen_t");
__static_renaming("____bswap_32_855", "__bswap_32");
__static_renaming("____bswap_64_858", "__bswap_64");
__static_renaming("____ctype_b_loc_873", "__ctype_b_loc");
__static_renaming("____ctype_b_loc_874", "__ctype_b_loc");
__static_renaming("____ctype_tolower_loc_875", "__ctype_tolower_loc");
__static_renaming("____ctype_toupper_loc_876", "__ctype_toupper_loc");
__static_renaming("__isalnum_877", "isalnum");
__static_renaming("__isalpha_878", "isalpha");
__static_renaming("__iscntrl_879", "iscntrl");
__static_renaming("__isdigit_880", "isdigit");
__static_renaming("__islower_881", "islower");
__static_renaming("__isgraph_882", "isgraph");
__static_renaming("__isprint_883", "isprint");
__static_renaming("__ispunct_884", "ispunct");
__static_renaming("__isspace_885", "isspace");
__static_renaming("__isupper_886", "isupper");
__static_renaming("__isxdigit_887", "isxdigit");
__static_renaming("__tolower_889", "tolower");
__static_renaming("__toupper_891", "toupper");
__static_renaming("__isblank_892", "isblank");
__static_renaming("__isascii_894", "isascii");
__static_renaming("__toascii_896", "toascii");
__static_renaming("___toupper_897", "_toupper");
__static_renaming("___tolower_898", "_tolower");
__static_renaming("____locale_t_906", "__locale_t");
__static_renaming("__locale_t_907", "locale_t");
__static_renaming("__isalnum_l_908", "isalnum_l");
__static_renaming("__isalpha_l_909", "isalpha_l");
__static_renaming("__iscntrl_l_910", "iscntrl_l");
__static_renaming("__isdigit_l_911", "isdigit_l");
__static_renaming("__islower_l_912", "islower_l");
__static_renaming("__isgraph_l_913", "isgraph_l");
__static_renaming("__isprint_l_914", "isprint_l");
__static_renaming("__ispunct_l_915", "ispunct_l");
__static_renaming("__isspace_l_916", "isspace_l");
__static_renaming("__isupper_l_917", "isupper_l");
__static_renaming("__isxdigit_l_918", "isxdigit_l");
__static_renaming("__isblank_l_919", "isblank_l");
__static_renaming("____tolower_l_922", "__tolower_l");
__static_renaming("__tolower_l_925", "tolower_l");
__static_renaming("____toupper_l_928", "__toupper_l");
__static_renaming("__toupper_l_931", "toupper_l");
__static_renaming("__optarg_932", "optarg");
__static_renaming("__optarg_933", "optarg");
__static_renaming("__optarg_934", "optarg");
__static_renaming("__optind_935", "optind");
__static_renaming("__opterr_936", "opterr");
__static_renaming("__optopt_937", "optopt");
__static_renaming("__getopt_946", "getopt");
__static_renaming("__getopt_947", "getopt");
__static_renaming("__getopt_long_953", "getopt_long");
__static_renaming("__getopt_long_954", "getopt_long");
__static_renaming("__getopt_long_only_960", "getopt_long_only");
__static_renaming("__getopt_long_only_961", "getopt_long_only");
__static_renaming("__buf_964", "buf");
__static_renaming("__bufsize_965", "bufsize");
__static_renaming("__i_966", "i");
__static_renaming("__cmd_967", "cmd");
__static_renaming("__main_968", "main");
...
__static_condition_renaming("__static_condition_default_849", "(defined _STDLIB_H) && (defined _BITS_TYPESIZES_H) && !(defined __GNU_LIBRARY__)");
__static_condition_renaming("__static_condition_default_856", "(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __GNU_LIBRARY__) && !(defined _ISbit)");
__static_condition_renaming("__static_condition_default_969", "(defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_970", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_971", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_972", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) && (defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __malloc_and_calloc_defined) && (defined CONFIG_FEATURE_CLEAN_UP) || (defined _STDLIB_H) && (defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_973", "!(defined _STDLIB_H) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_974", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_CLEAN_UP) || (defined _STDLIB_H) && (defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_975", "!(defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_976", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_977", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined __need_malloc_and_calloc) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_978", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) && (defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __malloc_and_calloc_defined) && !(defined CONFIG_FEATURE_CLEAN_UP) || (defined _STDLIB_H) && !(defined CONFIG_FEATURE_CLEAN_UP)");
__static_condition_renaming("__static_condition_default_979", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) || (defined _STDLIB_H) && !(defined _BITS_TYPESIZES_H) && (defined __GNU_LIBRARY__) && (defined __THROW) || (defined _STDLIB_H) && (defined _BITS_TYPESIZES_H) && !(defined __GNU_LIBRARY__) || (defined _STDLIB_H) && (defined _BITS_TYPESIZES_H) && (defined __GNU_LIBRARY__) && (defined __THROW)");
...
typedef unsigned char  ____u_char_798;// L30
typedef unsigned short int  ____u_short_799;// L31
typedef unsigned int  ____u_int_800;// L32
typedef unsigned long int  ____u_long_801;// L33
typedef signed char  ____int8_t_802;// L36
typedef unsigned char  ____uint8_t_803;// L37
typedef signed short int  ____int16_t_804;// L38
typedef unsigned short int  ____uint16_t_805;// L39
typedef signed int  ____int32_t_806;// L40
typedef unsigned int  ____uint32_t_807;// L41
typedef signed long int  ____int64_t_808;// L43
typedef unsigned long int  ____uint64_t_809;// L44
typedef long int  ____quad_t_810;// L52
typedef unsigned long int  ____u_quad_t_811;// L53
typedef unsigned long int  ____dev_t_812;// L109:L124
typedef unsigned int  ____uid_t_813;// L92:L125
typedef unsigned int  ____gid_t_814;// L92:L126
typedef unsigned long int  ____ino_t_815;// L94:L127
typedef unsigned long int  ____ino64_t_816;// L109:L128
typedef unsigned int  ____mode_t_817;// L92:L129
typedef unsigned long int  ____nlink_t_818;// L94:L130
typedef long int  ____off_t_819;// L93:L131
typedef long int  ____off64_t_820;// L108:L132
typedef int  ____pid_t_821;// L91:L133
struct ____anonymous_tag_822_823 {
int  ____val_824[2];// L72
};
typedef struct ____anonymous_tag_822_823  ____fsid_t_825;// L72:L134
typedef long int  ____clock_t_826;// L93:L135
typedef unsigned long int  ____rlim_t_827;// L94:L136
typedef unsigned long int  ____rlim64_t_828;// L109:L137
typedef unsigned int  ____id_t_829;// L92:L138
typedef long int  ____time_t_830;// L93:L139
typedef unsigned int  ____useconds_t_831;// L92:L140
typedef long int  ____suseconds_t_832;// L93:L141
typedef int  ____daddr_t_833;// L91:L143
typedef int  ____key_t_834;// L91:L144
typedef int  ____clockid_t_835;// L91:L147
typedef void  * (____timer_t_836);// L70:L150
typedef long int  ____blksize_t_837;// L93:L153
typedef long int  ____blkcnt_t_838;// L93:L158
typedef long int  ____blkcnt64_t_839;// L108:L159
typedef unsigned long int  ____fsblkcnt_t_840;// L94:L162
typedef unsigned long int  ____fsblkcnt64_t_841;// L109:L163
typedef unsigned long int  ____fsfilcnt_t_842;// L94:L166
typedef unsigned long int  ____fsfilcnt64_t_843;// L109:L167
typedef long int  ____fsword_t_844;// L93:L170
typedef long int  ____ssize_t_845;// L110:L172
typedef long int  ____syscall_slong_t_846;// L93:L175
typedef unsigned long int  ____syscall_ulong_t_847;// L94:L177
typedef ____off64_t_820  ____loff_t_848;// L181
typedef ____quad_t_810  * (____qaddr_t_850);// L182
typedef char  * (____caddr_t_851);// L183
typedef long int  ____intptr_t_852;// L110:L186
typedef unsigned int  ____socklen_t_853;// L92:L189
enum ____anonymous_tag_871_872 {
___ISupper_859 = ( ( 0 ) < 8 ? ( ( 1 << ( 0 ) ) << 8 ) : ( ( 1 << ( 0 ) ) >> 8 ) ),
___ISlower_860 = ( ( 1 ) < 8 ? ( ( 1 << ( 1 ) ) << 8 ) : ( ( 1 << ( 1 ) ) >> 8 ) ),
___ISalpha_861 = ( ( 2 ) < 8 ? ( ( 1 << ( 2 ) ) << 8 ) : ( ( 1 << ( 2 ) ) >> 8 ) ),
___ISdigit_862 = ( ( 3 ) < 8 ? ( ( 1 << ( 3 ) ) << 8 ) : ( ( 1 << ( 3 ) ) >> 8 ) ),
___ISxdigit_863 = ( ( 4 ) < 8 ? ( ( 1 << ( 4 ) ) << 8 ) : ( ( 1 << ( 4 ) ) >> 8 ) ),
___ISspace_864 = ( ( 5 ) < 8 ? ( ( 1 << ( 5 ) ) << 8 ) : ( ( 1 << ( 5 ) ) >> 8 ) ),
___ISprint_865 = ( ( 6 ) < 8 ? ( ( 1 << ( 6 ) ) << 8 ) : ( ( 1 << ( 6 ) ) >> 8 ) ),
___ISgraph_866 = ( ( 7 ) < 8 ? ( ( 1 << ( 7 ) ) << 8 ) : ( ( 1 << ( 7 ) ) >> 8 ) ),
___ISblank_867 = ( ( 8 ) < 8 ? ( ( 1 << ( 8 ) ) << 8 ) : ( ( 1 << ( 8 ) ) >> 8 ) ),
___IScntrl_868 = ( ( 9 ) < 8 ? ( ( 1 << ( 9 ) ) << 8 ) : ( ( 1 << ( 9 ) ) >> 8 ) ),
___ISpunct_869 = ( ( 10 ) < 8 ? ( ( 1 << ( 10 ) ) << 8 ) : ( ( 1 << ( 10 ) ) >> 8 ) ),
___ISalnum_870 = ( ( 11 ) < 8 ? ( ( 1 << ( 11 ) ) << 8 ) : ( ( 1 << ( 11 ) ) >> 8 ) ),
};
struct ____locale_struct_900 {
struct __forward_tag_reference_899  * (____locales_901[13]);// L0
const unsigned short int  * (____ctype_b_902);// L33
const int  * (____ctype_tolower_903);// L34
const int  * (____ctype_toupper_904);// L35
const char  * (____names_905[13]);// L38
};
typedef struct ____locale_struct_900  * (____locale_t_906);// L27:L39
typedef ____locale_t_906  __locale_t_907;// L42
struct __option_938 {
const char  * (__name_939);// L106
int  __has_arg_940;// L109
int  * (__flag_941);// L110
int  __val_942;// L111
};
...
struct __forward_tag_reference_899 { // generated union of struct variations
union {
};
};
...
// typedef moved to top of scope
// typedef moved to top of scope
static __inline unsigned int  (____bswap_32_855) (unsigned int  ____bsx_854) {
...
static __inline ____uint64_t_809  (____bswap_64_858) (____uint64_t_809  ____bsx_857) {
...
enum ____anonymous_tag_871_872 ;// L46
extern const unsigned short int  * (* ((____ctype_b_loc_873) (void  )));// L79:L80
extern const unsigned short int  * (* ((____ctype_b_loc_874) (void  )));// L79:L80
extern const ____int32_t_806  * (* ((____ctype_tolower_loc_875) (void  )));// L81:L82
extern const ____int32_t_806  * (* ((____ctype_toupper_loc_876) (void  )));// L83:L84
extern int  (__isalnum_877) (int  );// L102:L110
extern int  (__isalpha_878) (int  );// L102:L111
extern int  (__iscntrl_879) (int  );// L102:L112
extern int  (__isdigit_880) (int  );// L102:L113
extern int  (__islower_881) (int  );// L102:L114
extern int  (__isgraph_882) (int  );// L102:L115
extern int  (__isprint_883) (int  );// L102:L116
extern int  (__ispunct_884) (int  );// L102:L117
extern int  (__isspace_885) (int  );// L102:L118
extern int  (__isupper_886) (int  );// L102:L119
extern int  (__isxdigit_887) (int  );// L102:L120
extern int  (__tolower_889) (int  ____c_888);// L124
extern int  (__toupper_891) (int  ____c_890);// L127
extern int  (__isblank_892) (int  );// L102:L136
extern int  (__isascii_894) (int  ____c_893);// L150
extern int  (__toascii_896) (int  ____c_895);// L154
extern int  (___toupper_897) (int  );// L102:L158
extern int  (___tolower_898) (int  );// L102:L159
// typedef moved to top of scope
// typedef moved to top of scope
extern int  (__isalnum_l_908) (int  , ____locale_t_906  );// L265:L271
extern int  (__isalpha_l_909) (int  , ____locale_t_906  );// L265:L272
extern int  (__iscntrl_l_910) (int  , ____locale_t_906  );// L265:L273
extern int  (__isdigit_l_911) (int  , ____locale_t_906  );// L265:L274
extern int  (__islower_l_912) (int  , ____locale_t_906  );// L265:L275
extern int  (__isgraph_l_913) (int  , ____locale_t_906  );// L265:L276
extern int  (__isprint_l_914) (int  , ____locale_t_906  );// L265:L277
extern int  (__ispunct_l_915) (int  , ____locale_t_906  );// L265:L278
extern int  (__isspace_l_916) (int  , ____locale_t_906  );// L265:L279
extern int  (__isupper_l_917) (int  , ____locale_t_906  );// L265:L280
extern int  (__isxdigit_l_918) (int  , ____locale_t_906  );// L265:L281
extern int  (__isblank_l_919) (int  , ____locale_t_906  );// L265:L283
extern int  (____tolower_l_922) (int  ____c_920, ____locale_t_906  ____l_921);// L287
extern int  (__tolower_l_925) (int  ____c_923, ____locale_t_906  ____l_924);// L288
extern int  (____toupper_l_928) (int  ____c_926, ____locale_t_906  ____l_927);// L291
extern int  (__toupper_l_931) (int  ____c_929, ____locale_t_906  ____l_930);// L292
/* no function due to type errors in the function prototype */
extern char  * (__optarg_932);// L57
extern char  * (__optarg_933);// L57
extern char  * (__optarg_934);// L57
extern int  __optind_935;// L71
extern int  __opterr_936;// L76
extern int  __optopt_937;// L80
struct __option_938 ;// L104
extern int  (__getopt_946) (int  _____argc_943, char  * const  * (_____argv_944), const char  * (____shortopts_945));// L150:L151
extern int  (__getopt_947) (int  _____argc_943, char  * const  * (_____argv_944), const char  * (____shortopts_945));// L150:L151
extern int  (__getopt_long_953) (int  _____argc_948, char  * const  * (_____argv_949), const char  * (____shortopts_950), const struct __option_938  * (____longopts_951), int  * (____longind_952));// L173:L176
extern int  (__getopt_long_954) (int  _____argc_948, char  * const  * (_____argv_949), const char  * (____shortopts_950), const struct __option_938  * (____longopts_951), int  * (____longind_952));// L173:L176
extern int  (__getopt_long_only_960) (int  _____argc_955, char  * const  * (_____argv_956), const char  * (____shortopts_957), const struct __option_938  * (____longopts_958), int  * (____longind_959));// L177:L180
extern int  (__getopt_long_only_961) (int  _____argc_955, char  * const  * (_____argv_956), const char  * (____shortopts_957), const struct __option_938  * (____longopts_958), int  * (____longind_959));// L177:L180
int  (__main_968) (int  __argc_962, char  * (* (__argv_963))) {
...
if (__static_condition_default_970) {
 __buf_964  =  __malloc_486  ( __bufsize_965 ) ; // L26
}
if (__static_condition_default_971) {
 __buf_964  =  __malloc_487  ( __bufsize_965 ) ; // L26
}
if (__static_condition_default_972) {
