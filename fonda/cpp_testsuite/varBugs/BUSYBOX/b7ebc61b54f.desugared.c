...
__static_renaming("__all_fmt_798", "all_fmt");
__static_renaming("__all_fmt_799", "all_fmt");
__static_renaming("__all_fmt_800", "all_fmt");
__static_renaming("__main_803", "main");
...
__static_condition_renaming("__static_condition_default_804", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_805", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_LS_TIMESTAMPS) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_LS_TIMESTAMPS) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_LS_TIMESTAMPS) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_LS_TIMESTAMPS)");
__static_condition_renaming("__static_condition_default_806", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc) && (defined CONFIG_FEATURE_LS_TIMESTAMPS)");
...
__static_condition_renaming("__static_condition_default_808", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_809", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
...
/* no function due to type errors in the function prototype */
static unsigned int  __all_fmt_798;// L9
static unsigned int  __all_fmt_799;// L9
static unsigned int  __all_fmt_800;// L9
int  (__main_803) (int  __argc_801, char  * (* (__argv_802))) {
...
if (__static_condition_default_805) {
 __all_fmt_798  &= ~ ( 3U << 23 ) ; // L4:L16
}
if (__static_condition_default_806) {
 __all_fmt_800  &= ~ ( 3U << 23 ) ; // L4:L16
}
