...
__static_renaming("__strchr_pointer_218", "strchr_pointer");
__static_renaming("__starpos_219", "starpos");
__static_renaming("__process_commands_220", "process_commands");
...
__static_condition_renaming("__static_condition_default_222", "(defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_223", "(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && (defined SDSUPPORT) || (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined SDSUPPORT) || (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined SDSUPPORT) || (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_224", "(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_225", "!(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && (defined SDSUPPORT) || !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && (defined SDSUPPORT) || !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && (defined SDSUPPORT) || !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && (defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_226", "!(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && (defined SDSUPPORT)");
...
static char  * (__strchr_pointer_218)= "eiffel~1.gco*57";// L3
void  (__process_commands_220) () {
...
if (__static_condition_default_223) {
 __starpos_219  = (  __strchr_80  ( __strchr_pointer_217  + 4,'*') ) ; // L9
}
if (__static_condition_default_224) {
 __starpos_219  = (  __strchr_80  ( __strchr_pointer_218  + 4,'*') ) ; // L9
}
if (__static_condition_default_225) {
 __starpos_219  = (  __strchr_81  ( __strchr_pointer_217  + 4,'*') ) ; // L9
}
if (__static_condition_default_226) {
 __starpos_219  = (  __strchr_81  ( __strchr_pointer_218  + 4,'*') ) ; // L9
}
if (  __starpos_219  != ( ( void  * ) 0 ) )// L10
{
* (  __starpos_219  - 1 ) = '\0' ; // L11
}
...
int  (__main_229) (int  __argc_227, char  * (* (__argv_228))) {
