...
__static_renaming("__len_217", "len");
__static_renaming("__len_218", "len");
__static_renaming("__lfilename_221", "lfilename");
__static_renaming("__cardreader_222", "cardreader");
...
__static_condition_renaming("__static_condition_default_219", "(defined __STRICT_ANSI__) && (defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_220", "!(defined __STRICT_ANSI__) && (defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_223", "(defined SDSUPPORT)");
__static_condition_renaming("__static_condition_default_228", "!(defined SDSUPPORT)");
...
/* no function due to type errors in the function prototype */
/* no function due to type errors in the function prototype */
void  (__cardreader_222) (char  * (__prepend_216)) {
...
int  __len_217=  __strlen_108  ( __prepend_216 ) + 13 + 1;// L10

int  __len_218=  __strlen_109  ( __prepend_216 ) + 13 + 1;// L10

if (__static_condition_default_219) {
__static_type_error("invalid declaration of path under this presence condition");
}
...
char  __lfilename_221[13]= "FOLDERNAME12\0";// L15

__static_type_error("type error : no valid expression"); // L19
if (  __prepend_216  [ 0 ] == '\0' )// L20
{
__static_type_error("type error : no valid expression"); // L20
}
...
int  (__main_227) (int  __argc_224, char  * (* (__argv_225))) {
