...
__static_renaming("__spin_lock_irq_798", "spin_lock_irq");
__static_renaming("__spin_lock_irq_799", "spin_lock_irq");
__static_renaming("__spin_lock_irq_800", "spin_lock_irq");
__static_renaming("__spin_unlock_irq_804", "spin_unlock_irq");
__static_renaming("__spin_lock_bh_805", "spin_lock_bh");
__static_renaming("__spin_unlock_bh_806", "spin_unlock_bh");
__static_renaming("__kunmap_skb_frag_807", "kunmap_skb_frag");
__static_renaming("__csum_810", "csum");
__static_renaming("__skb_checksum_811", "skb_checksum");
__static_renaming("__udp_checksum_complete_814", "udp_checksum_complete");
__static_renaming("__mask_815", "mask");
__static_renaming("__udp_poll_816", "udp_poll");
__static_renaming("__main_822", "main");
...
__static_condition_renaming("__static_condition_default_801", "!(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_802", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
...
__static_condition_renaming("__static_condition_default_808", "!(defined CONFIG_HIGHMEM)");
__static_condition_renaming("__static_condition_default_809", "(defined CONFIG_HIGHMEM)");
__static_condition_renaming("__static_condition_default_812", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_813", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_817", "!(defined _STDLIB_H) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_818", "!(defined _STDLIB_H) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_819", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
__static_condition_renaming("__static_condition_default_823", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc)");
...
/* no function due to type errors in the function prototype */
static inline void  (__spin_lock_irq_798) () {

if (__static_condition_default_801) {
...
static inline void  (__spin_lock_irq_799) () {
...
static inline void  (__spin_lock_irq_800) () {
...
static inline void  (__spin_unlock_irq_804) () {
...
static inline void  (__spin_lock_bh_805) () {
...
static inline void  (__spin_unlock_bh_806) () {
...
static inline void  (__kunmap_skb_frag_807) () {
...
unsigned int  (__skb_checksum_811) () {
...
return  __csum_810  ;// L45
}
}// L46


}
static int  (__udp_checksum_complete_814) () {
...
return  __skb_checksum_811 ( ) ;// L50
}
}// L51


}
unsigned int  (__udp_poll_816) () {
...
unsigned int  __mask_815= 0;// L55

if (__static_condition_default_817) {
 __spin_lock_irq_798 ( ) ; // L57
}
if (__static_condition_default_818) {
 __spin_lock_irq_799 ( ) ; // L57
}
if (__static_condition_default_803) {
...
{// L58
{
 ...
 __udp_checksum_complete_814 ( ) ; // L59
}
}// L60
}
}
...
__static_type_error("invalid type found in while statement");
 ...
 __spin_unlock_irq_804 ( ) ; // L61
return  __mask_815  ;// L63
}
}// L64


}
int  (__main_822) (int  __argc_820, char  * (* (__argv_821))) {
