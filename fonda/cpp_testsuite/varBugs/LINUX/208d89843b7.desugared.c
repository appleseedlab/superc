...
__static_renaming("__spin_lock_irq_252", "spin_lock_irq");
__static_renaming("__spin_lock_irq_253", "spin_lock_irq");
__static_renaming("__spin_unlock_irq_256", "spin_unlock_irq");
__static_renaming("__spin_lock_bh_257", "spin_lock_bh");
__static_renaming("__spin_unlock_bh_258", "spin_unlock_bh");
__static_renaming("__kunmap_skb_frag_259", "kunmap_skb_frag");
__static_renaming("__csum_262", "csum");
__static_renaming("__skb_checksum_263", "skb_checksum");
__static_renaming("__udp_checksum_complete_266", "udp_checksum_complete");
__static_renaming("__mask_267", "mask");
__static_renaming("__udp_poll_268", "udp_poll");
__static_renaming("__main_271", "main");
...
__static_condition_renaming("__static_condition_default_254", "!(defined _FORTIFY_SOURCE) || (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) || (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0)");
__static_condition_renaming("__static_condition_default_255", "(defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0)");
__static_condition_renaming("__static_condition_default_260", "!(defined CONFIG_HIGHMEM)");
__static_condition_renaming("__static_condition_default_261", "(defined CONFIG_HIGHMEM)");
__static_condition_renaming("__static_condition_default_264", "!(defined __USE_EXTERN_INLINES)");
...
/* no function due to type errors in the function prototype */
static inline void  (__spin_lock_irq_252) () {
...
static inline void  (__spin_lock_irq_253) () {
...
static inline void  (__spin_unlock_irq_256) () {
...
static inline void  (__spin_lock_bh_257) () {
...
static inline void  (__spin_unlock_bh_258) () {
...
static inline void  (__kunmap_skb_frag_259) () {
...
unsigned int  (__skb_checksum_263) () {
...
return  __csum_262  ;// L45
}
}


}
static int  (__udp_checksum_complete_266) () {
...
return  __skb_checksum_263 ( ) ;// L50
}
}


}
unsigned int  (__udp_poll_268) () {
...
unsigned int  __mask_267= 0;// L55

if (__static_condition_default_254) {
 __spin_lock_irq_252 ( ) ; // L57
}
if (__static_condition_default_255) {
 __spin_lock_irq_253 ( ) ; // L57
}
if (__static_condition_default_264) {
while ( rand( ) % 2 )// L58
{
...
{
{
 ...
 __udp_checksum_complete_266 ( ) ; // L59
}
}
}
}
...
{
{
 ...
 __spin_unlock_irq_256 ( ) ; // L61
return  __mask_267  ;// L63
}
}


}
int  (__main_271) (int  __argc_269, char  * (* (__argv_270))) {
