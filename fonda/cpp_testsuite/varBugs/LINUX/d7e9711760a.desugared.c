...
extern const bool __static_condition_default_799;
...
__static_renaming("__inode_get_rsv_space_802", "inode_get_rsv_space");
__static_renaming("__reserved_803", "reserved");
__static_renaming("__i_804", "i");
__static_renaming("__i_805", "i");
__static_renaming("__j_806", "j");
__static_renaming("__j_807", "j");
__static_renaming("__add_dquot_ref_808", "add_dquot_ref");
__static_renaming("__main_815", "main");
...
__static_condition_renaming("__static_condition_default_798", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_799", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined _FORTIFY_SOURCE) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && !(_FORTIFY_SOURCE > 0) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && !(defined __OPTIMIZE__) && !(defined __need_malloc_and_calloc) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && !(__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_800", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_801", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined _FORTIFY_SOURCE) && (_FORTIFY_SOURCE > 0) && (defined __OPTIMIZE__) && (__OPTIMIZE__ > 0) && !(defined __need_malloc_and_calloc)");
__static_condition_renaming("__static_condition_default_809", "!(defined CONFIG_QUOTA_DEBUG)");
__static_condition_renaming("__static_condition_default_810", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) && !(defined CONFIG_QUOTA_DEBUG)");
__static_condition_renaming("__static_condition_default_811", "(defined CONFIG_QUOTA_DEBUG)");
__static_condition_renaming("__static_condition_default_812", "!(defined _STDLIB_H) && (defined __STRICT_ANSI__) && !(defined __need_malloc_and_calloc) && (defined CONFIG_QUOTA_DEBUG)");
__static_condition_renaming("__static_condition_default_816", "!(defined _STDLIB_H) && !(defined __STRICT_ANSI__) || !(defined _STDLIB_H) && (defined __STRICT_ANSI__) && (defined __need_malloc_and_calloc) || (defined _STDLIB_H)");
...
/* no function due to type errors in the function prototype */
static int  (__inode_get_rsv_space_802) (void  ) {
...
__static_type_error("type error : no valid expression"); // L8
...
static void  (__add_dquot_ref_808) (void  ) {
...
for (  __i_804  = 0 ;  __i_804  < 10 ;  __i_804  ++ )// L21
{
...
for (  __i_805  = 0 ;  __i_805  < 10 ;  __i_805  ++ )// L21
{
...
if (  __inode_get_rsv_space_802 ( ) > 0 )// L29
{
 __reserved_803  = 1 ; // L30
}
__static_type_error("type error : no valid expression"); // L33
}
}// L34
...
int  (__main_815) (int  __argc_813, char  * (* (__arv_814))) {
