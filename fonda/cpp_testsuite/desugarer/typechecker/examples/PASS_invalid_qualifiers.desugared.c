...
if (1) {
__static_type_error("invalid declaration of f under this presence condition");
}

if (1) {
__static_type_error("invalid declaration of g under this presence condition");
}

if (1) {
__static_type_error("invalid declaration of h under this presence condition");
}
