...
__static_condition_renaming("__static_condition_default_18", "(defined B) && !(defined C)");
__static_condition_renaming("__static_condition_default_19", "(defined A) && (defined B) && !(defined C)");
__static_condition_renaming("__static_condition_default_21", "!(defined B) && (defined C)");
