...
__static_condition_renaming("__static_condition_default_18", "!A && (defined C)");
__static_condition_renaming("__static_condition_default_20", "!A && !(defined C)");
