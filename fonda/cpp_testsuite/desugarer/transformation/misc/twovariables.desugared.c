...
__static_condition_renaming("__static_condition_default_4", "(defined CONFIG_B) && (defined CONFIG_A) && (defined CONFIG_C)");
__static_condition_renaming("__static_condition_default_5", "(defined CONFIG_B) && !(defined CONFIG_A) || (defined CONFIG_B) && (defined CONFIG_A) && !(defined CONFIG_C)");
