...
__static_renaming("__decode_spi_frequency_430", "decode_spi_frequency");
...
enum __anonymous_tag_428 {
__SPI_FREQUENCY_20MHZ_425,
__SPI_FREQUENCY_33MHZ_426,
__SPI_FREQUENCY_50MHZ_427,
};
...
enum __anonymous_tag_428 ;
static void  __decode_spi_frequency_430 (unsigned int  __freq_429) {
{
switch (  __freq_429  ) { case  __SPI_FREQUENCY_20MHZ_425  : 
 __printf_226  ( "20MHz" ) ;

break ;


case  __SPI_FREQUENCY_33MHZ_426  : 
 __printf_226  ( "33MHz" ) ;

break ;


case  __SPI_FREQUENCY_50MHZ_427  : 
 __printf_226  ( "50MHz" ) ;
...
default : 
 __printf_226  ( "unknown<%x>MHz",  __freq_429  ) ;
