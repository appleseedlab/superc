...
plot \
\"$joined\" using (\$2/1000000):4 with points pt 3 ps 0.65 lc rgb \"#000000\" title \"Parse, Preprocess, and Lex\", \
\"$joined\" using (\$2/1000000):5 with points pt 1 ps 0.70 lc rgb \"#4D4D4D\" title \"Preprocess and Lex\", \
\"$joined\" using (\$2/1000000):6 with points pt 2 ps 0.60 lc rgb \"#999999\" title \"Lex\"
