 ...
 */
public class P4TokenCreator implements TokenCreator {

  public Language<?> createStringLiteral(String str) {
    return new Text<P4Tag>(P4Tag.STRING_LITERAL, str);
  }

  public Language<?> createIntegerConstant(int i) {
    return new Text<P4Tag>(P4Tag.INTEGER, ((Integer) i).toString());
  }

  public Language<?> createIdentifier(String ident) {
    return new Text<P4Tag>(P4Tag.IDENTIFIER, ident);
  }
