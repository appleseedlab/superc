...
/**
 * This class maintains the complete type context for one scope.
 *
 * @author Paul Gazzillo
 * @version $Revision: 1.2 $
 */
public class CTypeContext implements ParsingContext {
   ...
   */
  public CTypeContext(SymbolTable symtab, CTypeContext parent) {
    this.symtab = symtab;
    this.parent = parent;
   ...
   */
  public CTypeContext(CTypeContext scope) {
    this.symtab = scope.symtab.addRef();

    if (scope.parent != null) {
      this.parent = new CTypeContext(scope.parent);
  ...
  public boolean mayMerge(ParsingContext other) {
    if (! (other instanceof CTypeContext)) return false;

    return mergeable(this, (CTypeContext) other);
  }
   ...
   */
  private static boolean mergeable(CTypeContext s, CTypeContext t) {
    if ((null == s) && (null == t)) {
      return true;
  ...
  public ParsingContext merge(ParsingContext other) {
    CTypeContext scope = (CTypeContext) other;
   ...
   */
  public CTypeContext enterScope(PresenceCondition presenceCondition) {
    CTypeContext scope;
    ...
    scope = new CTypeContext(new SymbolTable(), new CTypeContext(scope));
   ...
   */
  public CTypeContext exitScope(PresenceCondition presenceCondition) {
    CTypeContext scope;
   ...
   * @return The parsing context of the parent scope.
   */
  public CTypeContext exitReentrantScope(PresenceCondition presenceCondition) {
    CTypeContext scope;
   ...
   */
  public CTypeContext reenterScope(PresenceCondition presenceCondition) {
   ...
   */
  public CTypeContext killReentrantScope(PresenceCondition presenceCondition) {
    CTypeContext scope;
