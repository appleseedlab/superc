...
# Test the SuperC lexer by lexing the files from the linux kernel and
# comparing the output against the original.
...
echo "Testing the lexer on the linux kernel."
