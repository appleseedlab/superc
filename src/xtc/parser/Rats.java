 ...
 * Copyright (C) 2004-2010 Robert Grimm
 *
...
public class Rats extends Tool {
  ...
  public void init() {
    ...
    runtime.
      ...
      bool("combined", "optionCombined", false,
           "Print grammar after combining into one module, then stop.").
  ...
  public void process(Node node) {
    ...
    if (runtime.test("optionLoaded") ||
        ...
        (null == module)) {
      return;
    } else if (runtime.test("optionCombined")) {
      if (runtime.test("optionHtml")) {
